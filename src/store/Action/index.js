...
export const fetchCategories = () => async(dispatch) =>{
    ...
    try{
        ...
        dispatch({
            type:"IS_ERROR",
            payload:error?.response?.data?.message || "failed to fetch the Category"
        })
    }
}
...
export const addUpdateUserAddress = (sendData,toast,addressId,SetOpenAddressModal) =>
    ...
    console.log("Request Received for editing address in Index", addressId);
...
export const getUserAddresses = () => async(dispatch,getState) =>{
    ...
    try{
        ...
        dispatch({
            type:"IS_ERROR",
            payload:error?.response?.data?.message || "failed to fetch the Address"
        })
    }
}
export const selectUserCheckOutAddress = (address)=>{
    console.log("Address disptach for Checkout")
    return  {
