    ...
    return(
        <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
                ...
                <ul className={`flex sm:gap-10 gap-4 sm:items-center text-slate-800 sm:static absolute left-0 top-[70px] sm:shadow-none shodow-md ${
                    ...
                    {/* <li className="font-[500] transition-all duration-150"> 
                        <Link className = "flex items-center border rounded-md  text-white gap-2 px-1 bg-lime-600"
                        to="/login">
                        <FaSignInAlt/>
                        <span>Login</span>
                        </Link>
